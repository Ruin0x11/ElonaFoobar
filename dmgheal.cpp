...
int dmghp(int target, int amount, int source, int element, int prm_857)
{
    int ele_at_m141 = 0;
    int c3_at_m141 = 0;
    int r_at_m141 = 0;
    ...
    label_1369_internal:
        ...
        if (ele_at_m141)
        {
            if (ele_at_m141 == 59)
            {
                ...
                {
                    dmgcon(target, status_ailment_t::blinded, rnd(prm_857 / 3 * 2 + 1));
                }
                if (rnd(20) < prm_857 / 50 + 4)
                {
                    dmgcon(target, status_ailment_t::paralyzed, rnd(prm_857 / 3 * 2 + 1));
                }
                if (rnd(20) < prm_857 / 50 + 4)
                {
                    dmgcon(target, status_ailment_t::confused, rnd(prm_857 / 3 * 2 + 1));
                }
                if (rnd(20) < prm_857 / 50 + 4)
                {
                    dmgcon(target, status_ailment_t::poisoned, rnd(prm_857 / 3 * 2 + 1));
                }
                if (rnd(20) < prm_857 / 50 + 4)
                {
                    dmgcon(target, status_ailment_t::sleep, rnd(prm_857 / 3 * 2 + 1));
                }
            }
            if (ele_at_m141 == 52)
            {
            ...
            if (ele_at_m141 == 53)
            {
                dmgcon(target, status_ailment_t::blinded, rnd(prm_857 + 1));
            }
            if (ele_at_m141 == 58)
            {
                dmgcon(target, status_ailment_t::paralyzed, rnd(prm_857 + 1));
            }
            if (ele_at_m141 == 54)
            {
                dmgcon(target, status_ailment_t::confused, rnd(prm_857 + 1));
            }
            if (ele_at_m141 == 57)
            {
                dmgcon(target, status_ailment_t::confused, rnd(prm_857 + 1));
            ...
            if (ele_at_m141 == 55)
            {
                dmgcon(target, status_ailment_t::poisoned, rnd(prm_857 + 1));
            }
            if (ele_at_m141 == 61)
            {
                dmgcon(target, status_ailment_t::bleeding, rnd(prm_857 + 1));
            }
            if (ele_at_m141 == 62)
            {
                if (target == 0)
        ...
        if ((ele_at_m141 == 50 || source == -9) && cdata[target].wet == 0)
        {
            item_fire(target, -1);
        }
        if (ele_at_m141 == 51)
        ...
        if (source >= 0)
        {
            ...
            {
                if (cdata[source].original_relationship > -3)
                {
            ...
            else if (cdata[source].original_relationship <= -3)
            {
                if (cdata[target].hate == 0 || rnd(4) == 0)
                {
                    f_at_m141 = 1;
            ...
            if (source != 0)
            {
                if (cdata[source].enemy_id == target)
                {
                    if (rnd(3) == 0)
                    {
                        f_at_m141 = 1;
    ...
    if (cdata[target].hp < 0)
    {
        ...
        if (source >= 0)
        {
            ...
            cdata[source].experience += exp_at_m141;
            if (source == 0)
            {
        ...
        if (source >= 0)
        {
            if (cdata[source].id == 260)
            {
                catitem = source;
            }
            if (int(std::sqrt(sdata(161, source))) > rnd(150))
            {
                rollanatomy = 1;
            }
            skillexp(161, source, 10 + rollanatomy * 4);
        }
        rc = target;
