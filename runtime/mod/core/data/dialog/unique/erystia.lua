   ...
   nodes = {
      ...
      all_stones = {
         ...
         on_finish = function()
            ...
            GUI.txt_colored("core.locale.talk.unique.erystia.all_stones.you_receive", "Green")
      ...
      stones = {
         ...
         on_finish = function()
            GUI.play_sound("core.write1")
            GUI.txt_colored("core.locale.talk.unique.erystia.stones.you_receive", "Green")
      ...
      pledge_strength = {
         ...
         on_finish = function()
            GUI.play_sound("core.write1")
            GUI.txt_colored("core.locale.talk.unique.erystia.introduction.pledge_strength.you_receive", "Green")
