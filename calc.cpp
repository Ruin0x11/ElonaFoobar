...
optional<skill_damage> calc_skill_damage(int skill, int cc, int power)
{
    ...
    case 601: return skill_damage{1 + x / 15, 7, x / 4, element_t::nether, 200};
    case 612: return skill_damage{1 + x / 20, 7, x / 15, element_t::none, 0};
    case 602: return skill_damage{1 + x / 15, 8, x / 8, element_t::fire, 100};
    case 603: return skill_damage{1 + x / 15, 8, x / 8, element_t::cold, 100};
    case 604: return skill_damage{1 + x / 15, 8, x / 8, element_t::lightning, 100};
    case 605: return skill_damage{1 + x / 15, 8, x / 8, element_t::darkness, 100};
    case 606: return skill_damage{1 + x / 15, 8, x / 8, element_t::chaos, 100};
    case 608: return skill_damage{1 + x / 15, 8, x / 8, element_t::nether, 100};
    case 610: return skill_damage{1 + x / 15, 8, x / 8, element_t::poison, 100};
    case 607: return skill_damage{1 + x / 15, 8, x / 8, element_t::sound, 100};
    case 609: return skill_damage{1 + x / 15, 8, x / 8, element_t::nerve, 100};
    case 611: return skill_damage{1 + x / 15, 8, x / 8, element_t::mind, 100};
    ...
    case 615: return skill_damage{1 + x / 10, 5, 0, element_t::poison, x * 4 + 20};
    case 616: return skill_damage{1 + x / 10, 5, 0, element_t::nerve, x * 4 + 20};
    case 636: return skill_damage{1 + x / 20, 11, 1, element_t::none, 0};
    case 655:
        return skill_damage{
            power / 80 + 1, power / 8 + 2 + 1, 0, element_t::sound, 150 + power / 2};
    default: return none;
    }
}
