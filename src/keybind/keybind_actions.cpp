...
void initialize_keybind_actions(ActionMap& actions)
{
    ...
    actions.emplace("enable_voldemort",      Action{ActionCategory::game,      {{Key::f10,             ModKey::none}}});
    ...
    actions.emplace("wizard_toggle_console", Action{ActionCategory::wizard,    {{Key::f12,             ModKey::shift}}});
    actions.emplace("wizard_open_console",   Action{ActionCategory::wizard,    {{Key::f12,             ModKey::none}}});
