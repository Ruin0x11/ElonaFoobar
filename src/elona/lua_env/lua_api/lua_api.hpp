...
/**
 * See doc/api for the API documentation. It's autogenerated with the "docgen"
 * tool under the "tools/" directory. Update it with "make docgen && make ldoc"
 * if you change anything in the API bindings.
 */
namespace elona
{
namespace lua
